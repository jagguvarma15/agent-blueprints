...
- **Combines with:** Human-in-the-Loop (planned: `patterns/human_in_the_loop/`) for compensator-failure escalation; [Multi-Agent (Flat)](../multi-agent/overview.md) when individual steps delegate to specialized agents
