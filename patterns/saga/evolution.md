...
This document traces how the [Saga pattern](./overview.md) evolves from sequential [Prompt Chaining](../../workflows/prompt-chaining/overview.md) augmented with [Tool Use](../tool-use/overview.md).
