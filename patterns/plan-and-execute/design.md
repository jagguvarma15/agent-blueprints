...
- **+ [Multi-Agent](../multi-agent/overview.md):** Delegate steps to specialized worker agents instead of a generic executor. Plan owns the *what*; agents own the *how*.
...
- **+ [Human in the Loop](../human-in-the-loop/overview.md):** Long or expensive plans surface to a human for approval before execution.
