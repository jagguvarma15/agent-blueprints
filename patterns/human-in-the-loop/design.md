...
- **+ [Event-Driven](../event-driven/overview.md)** — A proposal-pending event is published to an approval stream; the surface consumer renders it; the decision is published back as an event the agent consumer reacts to.
