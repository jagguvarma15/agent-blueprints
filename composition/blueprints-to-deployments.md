...
| [Plan & Execute](../patterns/plan-and-execute/overview.md) | `code-review-agent` |
| [Tool Use](../patterns/tool-use/overview.md) | `customer-support-triage`, `research-assistant` |
...
| [Multi-Agent](../patterns/multi-agent/overview.md) | `ops-crew` (flat), `hierarchical-agent` (hierarchical), `restaurant-rebooking` (flat) |
| [Event-Driven](../patterns/event-driven/overview.md) | `restaurant-rebooking` |
| [Saga](../patterns/saga/overview.md) | (no current recipe — candidate for booking/order workflows) |
| [Human in the Loop](../patterns/human-in-the-loop/overview.md) | (no current recipe — candidate for content moderation, code-review approval flows) |
